...
import 'loan_list_page_model.dart';
export 'loan_list_page_model.dart';
...
class _LoanListPageWidgetState extends State<LoanListPageWidget>
    with TickerProviderStateMixin {
  late LoanListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoanListPageModel());
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'Buscar emprestimo por titulo do livro',
                    ...
                    children: [
                      FutureBuilder<List<GetLoansRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewGetLoansRowList = snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemCount: listViewGetLoansRowList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 10.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewGetLoansRow =
                                  listViewGetLoansRowList[listViewIndex];
                              return Padding(
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: ReturnLoanWidget(
                                              id: listViewGetLoansRow.id!,
                                            ),
                                          ),
                                        );
                                      },
